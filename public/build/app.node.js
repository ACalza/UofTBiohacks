...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _formsyMaterialUi = __webpack_require__(23);

  var _formsyMaterialUi2 = _interopRequireDefault(_formsyMaterialUi);

  var _materialUiLibRaisedButton = __webpack_require__(27);
  ...
  var _reactCookie = __webpack_require__(29);

  var _reactCookie2 = _interopRequireDefault(_reactCookie);

  var _materialUiLibSnackbar = __webpack_require__(28);

  var _materialUiLibSnackbar2 = _interopRequireDefault(_materialUiLibSnackbar);

  var _servicesUriService = __webpack_require__(18);

  var _servicesUriService2 = _interopRequireDefault(_servicesUriService);
  ...
  var Login = (function (_Component) {
    ...
    _createClass(Login, [{
      ...
      value: function submitForm(model) {
        _jquery2['default'].ajax({
          type: 'POST',
          url: _servicesUriService2['default'].baseUri() + '/user/login',
          data: model,
          success: (function (data) {
            if (data.token) {
              _reactCookie2['default'].save('jwt', data.token);
              console.log(data);
            } else {
              this.setState({
                open: true
      ...
      value: function render() {
        return _react2['default'].createElement(
          ...
          _react2['default'].createElement(_formsyMaterialUi.FormsyText, { style: { display: 'block' },
            name: 'emailOrUsername',
            required: true, hintText: 'What is your Email or Username?',
            floatingLabelText: 'Email or Username'
          }),
          _react2['default'].createElement(_formsyMaterialUi.FormsyText, { style: { display: 'block' },
            name: 'password',
            type: 'password',
            required: true, hintText: 'What is your password?',
    ...
    var _Login = Login;
    Login = (0, _autobindDecorator2['default'])(Login) || Login;
    return Login;
  })(_react.Component);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsHomeHomeJs = __webpack_require__(5);
  ...
  var _default = (function (_Component) {
    ...
    _createClass(_default, [{
      key: 'render',
      value: function render() {
        return _react2['default'].createElement(_componentsHomeHomeJs2['default'], null);
      }
    }]);
...
/***/ function(module, exports, __webpack_require__) {
  ...
  var _componentsLoginLoginJs = __webpack_require__(8);
  ...
  var _default = (function (_Component) {
    ...
    _createClass(_default, [{
      ...
      value: function render() {
        ...
        if (_fbjsLibExecutionEnvironment.canUseDOM) {
          content = _react2['default'].createElement(_componentsLoginLoginJs2['default'], null);
        }
...
/***/ function(module, exports) {
  ...
  exports['default'] = new UriService();
  module.exports = exports['default'];
...
/***/ function(module, exports) {
  ...
  module.exports = require("formsy-material-ui");
...
/***/ function(module, exports) {
  ...
  module.exports = require("material-ui/lib/snackbar");
